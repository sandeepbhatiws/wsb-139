...
export default function Header() {
    ...
    return (
        ...
        <ToastContainer/>
            ...
            {/* <!-- Header --> */}
            <header
                class="bg-white mx-auto flex h-16 max-w-[1200px] items-center justify-between px-5"
            >
                <Link href="/">
                    <img
    ...
    < !--hidden on small devices-- > */}
            ...
            <nav class="relative bg-violet-900">
                ...
                >
                    ...
                    >
                        <div class="flex justify-around" onClick={ openMenu }>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
            ...
            <section
                ...
                class={ menuOpen ? 'absolute left-0 right-0 z-10 w-full border-b border-r border-l bg-white' : 'absolute left-0 right-0 z-10 w-full border-b border-r border-l bg-white hidden' }
            >
