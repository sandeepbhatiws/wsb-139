...
import { decrementByQuantity, deleteCart, incrementByQuantity } from '../Redux Toolkit/cartslice';
                  ...
                  cartItems.map((v, i) => {
                    return (
                      <tr class="h-[100px] border-b">
                        ...
                        <td class="align-middle">
                          <div class="flex items-center justify-center">
                            <button onClick={ () => dispatch(incrementByQuantity(v.id)) }
                              class="flex h-8 w-8 cursor-pointer items-center justify-center border duration-100 hover:bg-neutral-100 focus:ring-2 focus:ring-gray-500 active:ring-2 active:ring-gray-500"
                            >
                              &minus;
                            </button>
                            ...
                            <button onClick={ () => dispatch(decrementByQuantity(v.id)) }
                              class="flex h-8 w-8 cursor-pointer items-center justify-center border duration-100 hover:bg-neutral-100 focus:ring-2 focus:ring-gray-500 active:ring-2 active:ring-gray-500"
                            >
                              &#43;
                            </button>
